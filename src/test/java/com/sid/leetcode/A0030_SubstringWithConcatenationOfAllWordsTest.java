...
public class A0030_SubstringWithConcatenationOfAllWordsTest {

	private A0030_SubstringWithConcatenationOfAllWords problem;

	@Before
	public void setUp() throws Exception {
		problem = new A0030_SubstringWithConcatenationOfAllWords();
	}

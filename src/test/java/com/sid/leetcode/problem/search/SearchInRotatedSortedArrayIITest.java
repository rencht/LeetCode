...
import com.sid.leetcode.problem.search.SearchInRotatedSortedArrayII;

public class SearchInRotatedSortedArrayIITest {

	private SearchInRotatedSortedArrayII problem;

	@Before
	public void setUp() throws Exception {
		problem = new SearchInRotatedSortedArrayII();
	}
